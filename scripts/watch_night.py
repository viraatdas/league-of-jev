...
PAT = re.compile(r"order: .*(R Last|R kick|ignite|Flash|tornado)|fight\(jev\): (all_in|trade|escape)|fight:|escape|shop: b|dialog|lasthits|smite|jungle: cleared|error|Error|Traceback|paused|===|surrender|score|game \d+:|deaths:|launch [^2]|launch failed")
seen: dict[str, int] = {}
while True:
