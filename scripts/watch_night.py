...
PAT = re.compile(r"order: .*(R Last|R kick|ignite|Flash)|fight\(jev\): (all_in|escape|retreat)|fight:|ward:|gank:|gank (top|mid|bot)|objective:|bleeding|shop \(no Jev\)|escape: Flash|shop: b|dialog|lasthits|smite|jungle: cleared|error|Error|Traceback|paused|input paused|===|surrender|score|game \d+:|deaths:|launch [^2]|launch failed")
seen: dict[str, int] = {}
while True:
