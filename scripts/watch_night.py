...
PAT = re.compile(r"fight:|escape|shop: b|dialog|lasthits|smite|jungle: cleared|error|Error|Traceback|paused|===|surrender|score|game \d+:|deaths:|launch [^2]|launch failed")
seen: dict[str, int] = {}
while True:
