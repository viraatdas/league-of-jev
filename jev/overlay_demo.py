...
class DemoFeed:
    ...
    def snapshot(self) -> dict:
        ...
        return {
            ...
            "fight": {"plan": sc["intent"] if sc["intent"] in ("trade", "all_in") else "farm", "p": jit(0.55), "win": jit(0.62 if sc["intent"] == "all_in" else 0.35),
                      "trade": jit(0.58), "danger": jit(0.18), "gank": jit(0.22), "latency": random.uniform(130, 260), "age": 0.2,
                      "rate": 5.1, "focus": None},
